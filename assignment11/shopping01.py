...
# 2	       | 10	        | 3		      |         2.04s         |          10.17s
# 5	       | 10	        | 4			  |         2.03s         |          6.09s  
# 5	       | 39			| 5           |         2.04s           |  >= 40 s      38.64s
# +--------|------------|-------------|-----------------------|-------------------------    
# First, let's format the output into a table and save it to a text file.

# Defining a function to create a mock-up result to simulate output from the code provided
# Function to format the output into a table and save it to a text file.
